...
interface CorsoCarrelliTeoricoPageProps {
  onNavigate: (view: any) => void;
}

const CorsoCarrelliTeoricoPage: React.FC<CorsoCarrelliTeoricoPageProps> = ({ onNavigate }) => {
  const course = courses.find(c => c.id === "54") || {
    duration: "8h",
    price: "97,60 €",
  };
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Corso Carrelli Elevatori Modulo Teorico Online | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Corso online per il modulo teorico dell'abilitazione alla conduzione di carrelli elevatori. Formazione obbligatoria conforme all'Accordo Stato-Regioni.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20corso%20Carrelli%20Elevatori%20Teorico&body=Buongiorno%2C%0A%0ASono%20interessato%20al%20corso%20Abilitazione%20alla%20conduzione%20di%20carrelli%20elevatori%20–%20Modulo%20Teorico%20Online.%0APotrei%20avere%20maggiori%20informazioni%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Abilitazione <span className="text-brand">Carrelli Elevatori</span> Modulo Teorico Online
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Assolvi alla parte teorica obbligatoria per il "patentino" muletto comodamente online. Formazione certificata ai sensi dell'Accordo Stato-Regioni del 22/02/2012.
            </motion.p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-amber-200/80 text-sm leading-relaxed">
                  Questo corso copre <strong>SOLO la parte teorica</strong> dell'abilitazione. Per ottenere l'abilitazione completa (il cosiddetto "patentino"), è obbligatorio completare anche la parte pratica.
                </p>
              </div>
            </motion.div>
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    La conduzione di carrelli elevatori semoventi con conducente a bordo richiede una specifica abilitazione, spesso chiamata impropriamente "patentino muletto". Secondo l'Accordo Stato-Regioni del 22 febbraio 2012, questa abilitazione si ottiene attraverso un percorso formativo suddiviso in un modulo teorico e un modulo pratico.
                  </p>
                  <p>
                  ...
                  <p>
                    È fondamentale ricordare che, per legge, la sola teoria non abilita alla guida del mezzo. Una volta superato il test finale del modulo teorico online, il lavoratore dovrà affrontare la prova pratica su un carrello elevatore sotto la supervisione di un istruttore qualificato. Aliseo Academy supporta le aziende in tutto questo processo, garantendo una formazione di alta qualità conforme agli standard di sicurezza più rigorosi.
                  </p>
                </div>
              </article>
                ...
                <section>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                    <p className="text-slate-600 mb-6">
                      Il corso è rivolto a lavoratori, disoccupati o professionisti che intendono acquisire le competenze teoriche necessarie per la conduzione di carrelli elevatori.
                    </p>
                    <ul className="space-y-3">
                      {[
                        "Addetti alla logistica e magazzinieri",
                        "Operai in settori industriali e produttivi",
                        "Personale addetto al carico/scarico merci",
                        "Chiunque debba utilizzare saltuariamente un muletto",
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      "Apprendere le tipologie di carrelli e loro componenti",
                      "Comprendere i principi di stabilità e baricentro",
                      "Identificare i rischi durante le manovre",
                      "Conoscere le procedure di manutenzione giornaliera",
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { title: "Modulo Tecnico: tipologie di carrelli", desc: "Categorie di carrelli, componenti principali, dispositivi di comando e di sicurezza." },
                      { title: "Rischi connessi all'uso dei carrelli", desc: "Stabilità, baricentro, diagramma di carico, rischi di ribaltamento e procedure di sicurezza." },
                      { title: "Manutenzione e verifiche giornaliere", desc: "Controlli visivi e funzionali, ricarica batterie, rifornimento e manutenzione periodica." },
...
export default CorsoCarrelliTeoricoPage;
