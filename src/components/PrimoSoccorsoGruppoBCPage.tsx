            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    Il <strong>corso primo soccorso aziende</strong> per i Gruppi B e C è un pilastro fondamentale della sicurezza sul lavoro in Italia. Secondo quanto stabilito dal <strong>D.Lgs 81/08</strong> e dal <strong>DM 388/2003</strong>, ogni azienda deve designare e formare un numero adeguato di addetti al primo soccorso. Le aziende del Gruppo B e C comprendono la stragrande maggioranza delle realtà produttive e di servizio che non rientrano nelle categorie ad alto rischio del Gruppo A.
                  </p>
                  <p>
                    Il <strong>corso primo soccorso obbligatorio aziende</strong> per queste categorie ha una durata di 12 ore e mira a fornire le competenze necessarie per gestire le emergenze sanitarie più comuni che possono verificarsi in ufficio, in negozio o in piccoli laboratori artigianali. L'obiettivo non è trasformare il lavoratore in un medico, ma fornirgli gli strumenti per riconoscere un'emergenza, allertare i soccorsi professionali e attuare le prime manovre salvavita fondamentali.
                  </p>
                  <p>
