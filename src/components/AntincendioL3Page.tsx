            ...
            <div className="lg:col-span-2 space-y-16">
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  ...
                  <p>
                    Il nostro programma formativo è progettato per fornire non solo le basi teoriche sulla combustione e sulla prevenzione, ma anche le competenze pratiche essenziali per gestire scenari critici. Un addetto antincendio di Livello 3 deve essere in grado di intervenire tempestivamente utilizzando correttamente gli <strong>estintori portatili</strong>, gli idranti e coordinando l'evacuazione in situazioni di alta densità di affollamento. La sicurezza non è solo una conformità burocratica, ma una cultura operativa che Aliseo Academy promuove attraverso docenti esperti e metodologie didattiche efficaci.
                  </p>
                  <p>
                    Affidarsi ad Aliseo Academy per la formazione antincendio significa garantire alla propria azienda un servizio professionale, aggiornato alle ultime disposizioni legislative. Il corso prevede una parte teorica dedicata ai principi della combustione, alle misure di protezione e alle procedure da adottare in caso di incendio, seguita da una <strong>prova pratica di spegnimento</strong> e gestione dei presidi antincendio, fondamentale per acquisire la necessaria confidenza con le attrezzature di emergenza.
                  </p>
                </div>
              </article>
