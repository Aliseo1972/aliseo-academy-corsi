...
import { Clock, BookOpen, Euro, CheckCircle2, Users, FileText, ChevronRight, ShieldCheck, GraduationCap, Laptop, Award, Flame, Monitor, Scale } from 'lucide-react';
import { courses } from '../data/courses';
import OnlineLearningBenefits from './OnlineLearningBenefits';

interface CorsoRischioIncendioPageProps {
  onNavigate: (view: any) => void;
  onOpenCourse: (courseId: string) => void;
}

const CorsoRischioIncendioPage: React.FC<CorsoRischioIncendioPageProps> = ({ onNavigate, onOpenCourse }) => {
  const course = courses.find(c => c.id === "35");

  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Corso Rischio Incendio | Formazione E-learning Sicurezza";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Corso di formazione online sul rischio incendio. Prevenzione incendi, gestione emergenze ed evacuazione. Formazione e-learning certificata D.Lgs 81/08.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20corso%20Rischio%20Incendio&body=Buongiorno%2C%0A%0ASono%20interessato%20al%20corso%20e-learning%20sul%20Rischio%20Incendio.%0APotrei%20avere%20maggiori%20informazioni%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Corso <span className="text-brand">Rischio Incendio</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Formazione specifica sulla prevenzione incendi e sulla corretta gestione delle situazioni di emergenza, conforme al D.Lgs. 81/08.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="flex items-center gap-4 px-6 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm w-fit">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white font-bold">2h</span>
                </div>
                <div className="w-px h-6 bg-white/10" />
                <div className="flex items-center gap-2">
                  <Euro className="w-5 h-5 text-brand" />
                  <span className="text-white font-bold">€ 24,40 <span className="text-[10px] text-brand uppercase ml-1">iva inc.</span></span>
                </div>
              </div>
            </motion.div>
          </div>
              ...
              <article className="prose prose-slate max-w-none">
                <h2 className="text-3xl font-black text-slate-900 mb-6 flex items-center gap-3">
                 ...
                 <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                   <p>
                    Il corso Formazione per lavoratori – Rischio Incendio è rivolto a tutti i lavoratori, indipendentemente dal settore di appartenenza, con particolare riferimento a chi opera in ambienti in cui è prevista la presenza di materiali infiammabili o fonti di calore.
                  </p>
                  <p>
                    Il percorso formativo approfondisce i principali aspetti legati alla prevenzione incendi, alla corretta gestione delle situazioni di emergenza, alle procedure di evacuazione e alla collaborazione con gli addetti alla sicurezza.
                  </p>
                  <p>
                    Durante il corso vengono analizzati i fattori di rischio, i comportamenti corretti da adottare, le procedure previste dal piano di emergenza e le modalità di intervento in caso di principio d’incendio.
                  </p>
                  <p>
                ...
                <section>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        "Fornire ai lavoratori le conoscenze fondamentali sulla prevenzione incendi",
                        "Supportare una corretta gestione delle situazioni di emergenza",
                        "Riconoscere i fattori di rischio",
                        "Applicare le procedure previste dal piano di emergenza",
                        "Collaborare con gli addetti alla sicurezza per garantire l’evacuazione ordinata e la tutela delle persone"
                      ].map((obj, i) => (
                    ...
                    <div>
                      <ul className="space-y-2">
                        {[
                          ...
                          "Lavoratori che operano in ambienti con presenza di materiali infiammabili",
                          "Lavoratori esposti a fonti di calore",
                          "Figure coinvolte nelle procedure di emergenza ed evacuazione"
                        ].map((item, i) => (
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { title: "Rischio Incendio", duration: "1h 58m" },
                ...
                <section>
                  ...
                  <div className="bg-slate-900 rounded-3xl p-8 relative overflow-hidden group">
                    ...
                    <div className="relative space-y-4">
                      {[
                        { title: "Artt. 36, 37 D.Lgs. 81/08;", desc: "Informazione e formazione dei lavoratori", icon: Scale }
                      ].map((item, i) => (
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6">
            Necessiti di formazione sul rischio incendio?
          </h2>
          <p className="text-lg text-slate-600 mb-10">
            Il nostro team è a disposizione per supportarti nella valutazione dei rischi e nella definizione del percorso formativo più adatto.
          </p>
      ...
      <section className="py-16 border-t border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { id: "31", title: "Rischio Chimico", desc: "Gestione sostanze pericolose ed etichettatura CLP", icon: ShieldCheck },
              { id: "29", title: "Rischio Amianto", desc: "Informazione sui rischi e procedure di sicurezza", icon: BookOpen },
              { id: "30", title: "Rischio ATEX", desc: "Formazione sulle atmosfere esplosive", icon: Scale },
            ].map((item, i) => (
              <button 
                key={i}
...
export default CorsoRischioIncendioPage;
