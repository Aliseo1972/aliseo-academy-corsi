...
interface GwoArtSrHsibrPageProps {
  onNavigate: (view: any) => void;
}

const GwoArtSrHsibrPage: React.FC<GwoArtSrHsibrPageProps> = ({ onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "GWO ART SR-HSIBR | Single Rescuer: Hub, Spinner & Inside Blade Rescue | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Corso GWO ART SR-HSIBR dedicato alle tecniche avanzate di soccorso in autonomia in hub, spinner e all’interno della pala. Formazione specialistica certificata GWO.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20corso%20GWO%20ART%20SR-HSIBR&body=Buongiorno%2C%0A%0ASono%20interessato%20al%20corso%20GWO%20ART%20Single%20Rescuer%3A%20Hub%2C%20Spinner%20%26%20Inside%20Blade%20Rescue%20(SR-HSIBR).%0APotrei%20avere%20maggiori%20informazioni%20su%20modalit%C3%A0%2C%20prossime%20date%20e%20costi%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              GWO ART – <span className="text-brand">SR-HSIBR</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Single Rescuer: Hub, Spinner & Inside Blade Rescue. Tecniche avanzate di soccorso in autonomia nelle aree critiche delle turbine eoliche.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div>
                <p className="text-slate-400 text-sm mb-3 font-medium">
                  Formazione specialistica per soccorritori singoli in scenari complessi wind.
                </p>
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                <h2 className="text-3xl font-black text-slate-900 mb-6 flex items-center gap-3">
                  ...
                  Soccorso Individuale in Hub e Pale
                </h2>
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    Il corso <strong>GWO ART – Single Rescuer: Hub, Spinner & Inside Blade Rescue (SR-HSIBR)</strong> è un modulo avanzato dell’Advanced Rescue Training (ART), progettato per sviluppare le competenze necessarie a gestire operazioni di soccorso in autonomia all’interno delle turbine eoliche.
                  </p>
                  <p>
                    Questo corso è specificamente rivolto a operatori che devono essere in grado di intervenire come soccorritori singoli in scenari complessi, come hub, spinner e interno pala, dove l’intervento immediato può essere determinante.
                  </p>
                  <p>
                    Durante la formazione, i partecipanti apprendono come pianificare ed eseguire operazioni di recupero senza supporto diretto, utilizzando in modo efficace le attrezzature di soccorso e adottando procedure sicure anche in condizioni critiche. Particolare attenzione è dedicata alla gestione dello stress, alla valutazione del rischio e alla capacità decisionale, elementi fondamentali quando si opera in autonomia.
                  </p>
                </div>
              </article>
              ...
              <section className="bg-amber-50 border border-amber-100 rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 text-amber-800/80">
                    <p>
                      Il certificato <strong>GWO ART SR-HSIBR</strong> ha una validità di <strong>2 anni</strong>.
                    </p>
                    <p>
                    ...
                    <div className="flex items-center gap-3 bg-white/50 w-fit px-4 py-2 rounded-xl border border-amber-200">
                      ...
                      <span className="font-bold text-amber-900 tracking-tight">GWO ART SR-HSIBR Refresher</span>
                    </div>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      "Intervenire in hub, spinner e all’interno della pala",
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                      ...
                      <ul className="space-y-2 text-sm text-slate-500">
                        <li>• Tecniche di soccorso individuale in hub e spinner</li>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-sm">GWO ART SR-HSIBR</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                ...
                <p className="text-sm text-slate-600">
                  Per accedere al modulo SR-HSIBR è necessario possedere una certificazione GWO ART base e GWO BST in corso di validità.
                </p>
              </div>
            </div>
          </div>
...
export default GwoArtSrHsibrPage;
