...
import { Clock, BookOpen, Euro, CheckCircle2, Users, FileText, ChevronRight, ShieldCheck, GraduationCap, Laptop, Award, AlertTriangle, Zap, Droplets, Monitor, Scale } from 'lucide-react';
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Formazione specifica sulla gestione dei rischi da interferenza, conforme al D.Lgs. 81/08.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    Il corso Formazione per lavoratori – Rischio Interferenze è rivolto a tutti i lavoratori che operano in contesti caratterizzati da appalti, subappalti o attività in co-presenza, sia in ambito pubblico che privato.
                  </p>
                  <p>
                    Il percorso formativo approfondisce i rischi da interferenza che possono derivare dalla presenza simultanea di più imprese o lavoratori autonomi nello stesso luogo di lavoro.
                  </p>
                  <p>
                    Durante il corso vengono analizzate le situazioni di rischio, le misure di prevenzione e collaborazione, le procedure di sicurezza previste e l’importanza del coordinamento tra i soggetti coinvolti.
                  </p>
                  <p>
                ...
                <section>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        "Fornire ai lavoratori una chiara comprensione dei rischi da interferenza",
                        "Comprendere i rischi che possono derivare dalla presenza simultanea di più imprese o lavoratori autonomi nello stesso luogo di lavoro",
                        "Individuare le situazioni di rischio",
                        "Applicare correttamente le misure di prevenzione e collaborazione",
                        "Attuare le procedure di sicurezza previste"
                      ].map((item, i) => (
                  ...
                  <div className="bg-white border border-slate-200 rounded-3xl p-8 flex items-center gap-6 shadow-sm">
                    ...
                    <div>
                      <ul className="space-y-2">
                        {[
                          "Lavoratori che operano in contesti caratterizzati da appalti e subappalti",
                          "Lavoratori coinvolti in attività in co-presenza",
                          "Addetti di aziende committenti, appaltatrici e subappaltatrici",
                          "Figure operative che lavorano in ambienti condivisi, pubblici o privati"
                        ].map((item, i) => (
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { title: "Rischio Interferenze", duration: "2h 3m" },
                ...
                <section>
                  ...
                  <div className="bg-slate-900 rounded-3xl p-8 relative overflow-hidden group">
                    ...
                    <div className="relative space-y-4">
                      {[
                        { title: "Art. 32 D. Lgs 81/08;", desc: "Riferimento normativo per la gestione dei rischi da interferenza", icon: Scale }
                      ].map((item, i) => (
      ...
      <section className="py-16 border-t border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { id: "32", title: "Rischio Elettrico", desc: "Prevenzione dei rischi da contatto elettrico", icon: Zap, type: "course" },
              { id: "31", title: "Rischio Chimico", desc: "Uso sicuro di sostanze e schede di sicurezza", icon: Droplets, type: "course" },
              { id: "corso-dpi-terza-categoria-lavori-quota", title: "DPI III Categoria", desc: "Uso corretto dei dispositivi salvavita", icon: ShieldCheck, type: "navigate" },
            ].map((item, i) => (
              <button 
                key={i}
                onClick={() => item.type === "course" ? onOpenCourse(item.id) : onNavigate(item.id)}
