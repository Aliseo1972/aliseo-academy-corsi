            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    L'<strong>aggiornamento primo soccorso obbligatorio</strong> è un adempimento normativo essenziale per tutte le aziende classificate nei Gruppi B e C. Come stabilito dal <strong>D.Lgs 81/08</strong> e dal <strong>DM 388/2003</strong>, la validità della formazione base per gli addetti al primo soccorso ha una durata di tre anni, trascorsi i quali è necessario frequentare un corso di aggiornamento per mantenere attiva l'abilitazione.
                  </p>
                  <p>
                    Per le aziende dei Gruppi B e C, l'<strong>aggiornamento primo soccorso aziende</strong> ha una durata di 4 ore. Questo percorso formativo è progettato per rinfrescare le conoscenze teoriche ma, soprattutto, per consolidare le abilità pratiche necessarie a intervenire efficacemente in caso di infortunio o malore improvviso sul luogo di lavoro. Aliseo Academy propone un approccio didattico focalizzato sull'operatività, garantendo che ogni addetto sia pronto ad agire con calma e precisione.
                  </p>
                  <p>
