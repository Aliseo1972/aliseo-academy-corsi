            ...
            <div className="lg:col-span-2 space-y-16">
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    L'<strong>aggiornamento antincendio obbligatorio</strong> Livello 1 (L1) è un adempimento fondamentale sancito dal <strong>D.Lgs 81/08</strong> e ulteriormente specificato dal <strong>D.M. 2 settembre 2021</strong>. La normativa prevede che gli addetti alla squadra antincendio debbano frequentare corsi di aggiornamento con cadenza almeno quinquennale per mantenere operative le proprie competenze e restare informati sulle nuove procedure e tecnologie di prevenzione.
                  </p>
                  <p>
                    Per le attività classificate a <strong>Livello 1 (ex rischio basso)</strong>, l'aggiornamento ha una durata di 2 ore e si focalizza principalmente sulla parte pratica. È fondamentale che un addetto, anche se opera in un ambiente a basso rischio, sappia come reagire prontamente in caso di emergenza, come utilizzare un estintore senza esitazioni e come guidare i colleghi verso le uscite di sicurezza.
                  </p>
                  <p>
