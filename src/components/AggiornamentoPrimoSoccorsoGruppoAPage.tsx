            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  <p>
                    L'<strong>aggiornamento primo soccorso obbligatorio</strong> rappresenta un momento cruciale per il mantenimento delle competenze salvavita all'interno delle aziende classificate nel Gruppo A. Secondo quanto disposto dal <strong>D.Lgs 81/08</strong> e dal <strong>DM 388/2003</strong>, la formazione degli addetti al primo soccorso non è un evento isolato, ma un percorso continuo che richiede un rinnovo periodico ogni tre anni.
                  </p>
                  <p>
                    Per le aziende del Gruppo A, caratterizzate da un elevato indice di rischio o da particolari complessità operative, l'<strong>aggiornamento primo soccorso aziende</strong> ha una durata minima di 6 ore. Questo tempo è dedicato principalmente al ripasso delle manovre pratiche e all'aggiornamento sulle nuove linee guida internazionali in ambito di soccorso sanitario. Aliseo Academy struttura questi corsi per massimizzare l'efficacia dell'apprendimento, concentrandosi sulla capacità di reazione immediata in caso di emergenza.
                  </p>
                  <p>
