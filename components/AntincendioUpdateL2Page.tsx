...
interface AntincendioUpdateL2PageProps {
  onNavigate: (view: any) => void;
}

const AntincendioUpdateL2Page: React.FC<AntincendioUpdateL2PageProps> = ({ onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Aggiornamento Antincendio Livello 2 (L2) | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Assicura la conformità con l'aggiornamento antincendio ogni 5 anni per il Livello 2 (L2) con Aliseo Academy. Corso obbligatorio per addetti emergenze a norma DM 02/09/2021.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20aggiornamento%20Antincendio%20Livello%202&body=Buongiorno%2C%0A%0ASono%20interessato%20all'aggiornamento%20Antincendio%20Livello%202%20(L2).%0APotrei%20avere%20maggiori%20informazioni%20su%20modalit%C3%A0%2C%20prossime%20date%20e%20costi%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Aggiornamento Antincendio <span className="text-brand">Livello 2 (L2)</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Corso di aggiornamento quinquennale obbligatorio per addetti alla prevenzione incendi in attività di Livello 2 (ex rischio medio).
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="flex items-center gap-4 px-6 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm w-fit">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white font-bold">5 ore</span>
                </div>
            ...
            <div className="lg:col-span-2 space-y-16">
              <article className="prose prose-slate max-w-none">
                <h2 className="text-3xl font-black text-slate-900 mb-6 flex items-center gap-3">
                  ...
                  Perché l'Aggiornamento Antincendio ogni 5 anni?
                </h2>
                ...
                <section>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start gap-3 text-slate-600">
                        <CheckCircle2 className="w-6 h-6 text-brand shrink-0" />
                        Esercitazione pratica sull'uso degli estintori portatili e idranti.
                      </li>
                    </ul>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { title: "Esercitazioni pratiche", content: "Presa visione dei mezzi di estinzione, prova pratica di utilizzo dell'estintore su apposito focolare e idranti." }
                    ].map((item, i) => (
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold">5 ore</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
...
export default AntincendioUpdateL2Page;
