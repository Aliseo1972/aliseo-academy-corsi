...
interface AntincendioUpdateL3PageProps {
  onNavigate: (view: any) => void;
}

const AntincendioUpdateL3Page: React.FC<AntincendioUpdateL3PageProps> = ({ onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Aggiornamento Antincendio Livello 3 (L3) | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Aggiornamento antincendio Livello 3 (L3) per attività ad alto rischio. Il corso antincendio obbligatorio aziende di Aliseo Academy garantisce massima sicurezza e conformità.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20aggiornamento%20Antincendio%20Livello%203&body=Buongiorno%2C%0A%0ASono%20interessato%20all'aggiornamento%20Antincendio%20Livello%203%20(L3).%0APotrei%20avere%20maggiori%20informazioni%20su%20modalit%C3%A0%2C%20prossime%20date%20e%20costi%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Aggiornamento Antincendio <span className="text-brand">Livello 3 (L3)</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Corso di aggiornamento quinquennale obbligatorio per addetti alla prevenzione incendi in attività di Livello 3 (ex rischio alto).
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="lg:col-span-2 space-y-16">
              <article className="prose prose-slate max-w-none">
                <h2 className="text-3xl font-black text-slate-900 mb-6 flex items-center gap-3">
                  ...
                  Il Corso Antincendio Obbligatorio per Aziende ad Alto Rischio
                </h2>
                ...
                <section>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start gap-3 text-slate-600">
                        <CheckCircle2 className="w-6 h-6 text-brand shrink-0" />
                        Esercitazione pratica sull'uso degli estintori portatili, idranti e naspi.
                      </li>
                    </ul>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { title: "Esercitazioni pratiche", content: "Presa visione dei mezzi di estinzione, prova pratica di utilizzo dell'estintore su apposito focolare, idranti e naspi." }
                    ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Livello 3 (L3)", desc: "Base - 16 ore", view: 'antincendio-l3', icon: Flame },
...
export default AntincendioUpdateL3Page;
