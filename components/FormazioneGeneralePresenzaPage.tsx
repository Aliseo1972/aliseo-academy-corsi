...
interface FormazioneGeneralePresenzaPageProps {
  onNavigate: (view: any) => void;
}

const FormazioneGeneralePresenzaPage: React.FC<FormazioneGeneralePresenzaPageProps> = ({ onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Corso Formazione Generale Lavoratori in Presenza | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Corso formazione generale lavoratori obbligatorio (4 ore) in presenza presso la nostra sede o on-site presso il cliente. Aliseo Academy.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20corso%20Formazione%20Generale%20Lavoratori%20in%20Presenza&body=Buongiorno%2C%0A%0ASono%20interessato%20al%20corso%20Formazione%20Generale%20Lavoratori%20(4%20ore)%20in%20modalit%C3%A0%20in%20presenza.%0APotrei%20avere%20maggiori%20informazioni%20su%20date%2C%20costi%20e%20possibilit%C3%A0%20di%20svolgimento%20on-site%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              La base fondamentale della sicurezza sul lavoro: 4 ore di formazione obbligatoria in presenza con docenti qualificati.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div>
                <p className="text-slate-400 text-sm mb-3 font-medium">
                  Disponibile in presenza presso il nostro centro formativo o on-site presso la vostra sede.
                </p>
                <div className="flex flex-col gap-2">
                  ...
                  >
                    Richiedi preventivo per la tua azienda
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-6 text-lg">
                  ...
                  <p>
                    La formazione in presenza permette un'interazione diretta con i nostri docenti qualificati, favorendo il confronto e l'approfondimento dei temi trattati. Aliseo Academy organizza sessioni formative presso il proprio centro o direttamente on-site presso la sede del cliente, garantendo la massima flessibilità organizzativa.
                  </p>
                  <p>
                    I nostri corsi in aula sono progettati per coinvolgere attivamente i partecipanti, utilizzando metodologie didattiche esperienziali che facilitano l'apprendimento e la memorizzazione dei concetti chiave della sicurezza sul lavoro, garantendo al contempo la massima efficacia didattica e il pieno rispetto della normativa vigente.
                  </p>
                </div>
              </article>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-sm">In Presenza / On-site</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
...
export default FormazioneGeneralePresenzaPage;
