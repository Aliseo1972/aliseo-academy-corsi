...
interface AggiornamentoEvacuatoreEmergenzaPageProps {
  onNavigate: (view: any) => void;
}

const AggiornamentoEvacuatoreEmergenzaPage: React.FC<AggiornamentoEvacuatoreEmergenzaPageProps> = ({ onNavigate }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Aggiornamento Evacuatore di Emergenza - Formazione 4 ore | Aliseo Academy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Corso di aggiornamento per addetti all'evacuazione di emergenza (4 ore) in conformità al D.Lgs 81/08. Mantenimento delle competenze per la gestione delle emergenze.");
    }
  }, []);

  const mailtoLink = "mailto:commerciale@aliseogroup.it?subject=Richiesta%20informazioni%20Aggiornamento%20Evacuatore%20di%20Emergenza&body=Buongiorno%2C%0A%0ASono%20interessato%20all'Aggiornamento%20Evacuatore%20di%20Emergenza%20(4%20ore).%0APotrei%20avere%20maggiori%20informazioni%20su%20modalit%C3%A0%2C%20prossime%20date%20e%20costi%3F%0A%0AGrazie.";
      ...
      <section className="relative pt-20 pb-16 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Aggiornamento <span className="text-brand">Evacuatore Emergenza</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Corso di aggiornamento obbligatorio per mantenere le competenze operative nella gestione delle procedure di evacuazione e assistenza.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-16">
              ...
              <article className="prose prose-slate max-w-none">
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  <p>
                    Il <strong>Corso di Aggiornamento Evacuatore di Emergenza – 4 ore</strong> è rivolto ai lavoratori incaricati di supportare le operazioni di evacuazione durante le situazioni di emergenza, con particolare attenzione all’assistenza di persone con mobilità ridotta o disabilità presenti nei luoghi di lavoro.
                  </p>
                  <p>
                    La formazione rientra tra le attività previste dal <strong>Decreto Legislativo 81/2008</strong>, che stabilisce l’obbligo per il datore di lavoro di organizzare adeguate procedure di emergenza ed evacuazione e di garantire la sicurezza di tutti i lavoratori e delle persone presenti.
                  </p>
                  <p>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                    ...
                    <p className="text-slate-600">
                      Mantenere e rafforzare le competenze operative per la gestione delle procedure di evacuazione e l'utilizzo delle attrezzature.
                    </p>
                  </div>
                </div>
            ...
            <aside className="space-y-8">
              ...
              <div className="bg-brand/5 p-8 rounded-[2.5rem] border border-brand/10">
                ...
                <div className="space-y-4">
                  <button 
                    onClick={() => onNavigate('corso-evacuatore-emergenza')}
                  ...
                  >
                    ...
                    <p className="text-slate-900 font-bold group-hover:text-brand transition-colors">Corso Evacuatore Emergenza</p>
                  </button>
                  <button 
      ...
      <section className="py-16 border-t border-slate-100 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Corso Evacuatore", desc: "Formazione 8 ore", view: 'corso-evacuatore-emergenza', icon: Clock },
...
export default AggiornamentoEvacuatoreEmergenzaPage;
