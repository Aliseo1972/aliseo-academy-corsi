...
import { Clock, BookOpen, Euro, CheckCircle2, Users, FileText, ChevronRight, ShieldCheck, GraduationCap, Laptop, Award, Zap, AlertTriangle, Home, Flame } from 'lucide-react';
...
const CorsoRischioIncendioPage: React.FC<CorsoRischioIncendioPageProps> = ({ onNavigate, onOpenCourse }) => {
  ...
  const relatedCourses = [
    { id: "1", title: "Antincendio Livello 1" },
    { id: "31", title: "Rischio Chimico" },
    { id: "30", title: "Rischio Atmosfere Esplosive" }
  ];
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              <div className="relative h-80 rounded-3xl overflow-hidden mb-8 group">
                <img 
                  src="https://images.unsplash.com/photo-1542353436-312f0ee59301?auto=format&fit=crop&q=80&w=1200" 
                  alt={course.title}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent flex flex-col justify-end p-8">
                  ...
                  <p className="text-slate-200 text-lg max-w-2xl font-medium leading-tight">
                    Corso di formazione obbligatorio sulla prevenzione incendi ed evacuazione ai sensi del D.M. 02/09/2021.
                  </p>
                </div>
              </div>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  Il rischio incendio è uno dei pericoli più trasversali e critici in ogni ambiente di lavoro. La corretta gestione di questo rischio non si limita alla presenza di estintori, ma richiede una profonda consapevolezza da parte di tutti i lavoratori sulle dinamiche della combustione, sulle procedure di prevenzione e sulle corrette modalità di evacuazione. Questo corso e-learning fornisce le basi fondamentali per garantire la sicurezza propria e dei colleghi in caso di emergenza.
                </p>
                <p className="text-slate-600 leading-relaxed mb-6">
                  Il programma didattico analizza in dettaglio il "triangolo del fuoco", spiegando come l'interazione tra combustibile, comburente e calore generi l'incendio e come intervenire per interrompere questa reazione. Vengono presentate le diverse classi di fuoco e le relative sostanze estinguenti, con un focus particolare sull'uso corretto degli estintori portatili e delle altre attrezzature antincendio presenti in azienda.
                </p>
                <p className="text-slate-600 leading-relaxed mb-6">
                  Una parte significativa del corso è dedicata alla gestione delle emergenze e all'evacuazione. I lavoratori impareranno a riconoscere i segnali di allarme, a percorrere le vie di esodo in sicurezza e a collaborare attivamente con gli addetti alle emergenze. La formazione include anche le procedure per la chiamata ai soccorsi esterni (Vigili del Fuoco), garantendo che le informazioni trasmesse siano precise e tempestive.
                </p>
                <p className="text-slate-600 leading-relaxed mb-6">
                  Aggiornato secondo le disposizioni del D.M. 02/09/2021, il corso assicura la conformità normativa e promuove una cultura della sicurezza proattiva. La modalità e-learning offre un'esperienza formativa flessibile e coinvolgente, con test di verifica che garantiscono il raggiungimento degli obiettivi didattici prefissati.
                </p>
              </div>
            </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-600 leading-relaxed">
                  {course.recipients}. Il corso è rivolto a tutto il personale aziendale che deve ricevere l'informazione e la formazione generale sul rischio incendio, come previsto dal D.Lgs. 81/08.
                </p>
              </section>
