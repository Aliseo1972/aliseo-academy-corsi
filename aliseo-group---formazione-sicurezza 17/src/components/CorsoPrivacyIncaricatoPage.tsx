      ...
      <section className="py-16 border-t border-slate-100 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Privacy Sanitaria", desc: "Incaricato nel settore sanitario", view: 'home', icon: Database },
              { title: "Sicurezza Lavoratori", desc: "Formazione obbligatoria 81/08", view: 'dlgs-81-08', icon: ShieldCheck },
              { title: "HACCP", desc: "Igiene e sicurezza alimentare", view: 'home', icon: GraduationCap },
            ].map((item, i) => (
              <button 
                key={i}
